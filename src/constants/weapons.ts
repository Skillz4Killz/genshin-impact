export const weapons = new Map([
  ...
  [
    "lithicblade",
    {
      ...
      refinement:
        "For every character in the party who hails from Liyue, the character who equips this weapon gains **7/8/9/10/11%** ATK increase and **3/4/5/6/7%** CRIT Rate increase. This effect stacks up to 4 times.",
    },
  ],
  [
    "serpentspine",
  ...
  [
    "alleyhunter",
    {
      ...
      thumbnail:
        "https://static.wikia.nocookie.net/gensin-impact/images/0/0a/Weapon_Alley_Hunter.png/revision/latest/scale-to-width-down/310?cb=20210312043617",
      color: "RANDOM",
      category: "Bow",
      stars: "⭐⭐⭐⭐",
      baseAttack: "44/565",
      ...
      refinement:
        "While the character equipped with this weapon is in the party but not on the field, their DMG increases by **2/2,5/3/3,5/4%** every second up to a max of **20/25/30/35/40%**. When the character is on the field for more than 4s, the aforementioned DMG buff decreases by **4/5/6/7/8%** per second until it reaches 0%.",
    },
  ],
  [
    "thestringless",
  ...
  [
    "songofbrokenpines",
    {
      ...
      thumbnail:
        "https://static.wikia.nocookie.net/gensin-impact/images/d/dd/Weapon_Song_of_Broken_Pines.png/revision/latest/scale-to-width-down/310?cb=20210422045918",
      color: "RANDOM",
      category: "Claymore",
      stars: "⭐⭐⭐⭐⭐",
      baseAttack: "49/741",
      ...
      moreInfo:
        "https://genshin.honeyhunterworld.com/db/weapon/uprising_satire/",
      refinement:
