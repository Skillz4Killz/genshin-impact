export const weapons = new Map([
  [
    "coolsteel",
    {
      name: "Cool Steel",
      description:
        "A reliable steel-forged weapon that serves as a testament to the great adventures of it's old master.",
      thumbnail: "https://i.imgur.com/U5Flt6t.png",
      image: "https://i.imgur.com/U5Flt6t.png",
      color: "",
      category: "Sword",
      stars: "⭐⭐⭐",
      baseAttack: "39",
