...
createSubcommand("patchnotes", {
  ...
  execute: async function (message) {
    const firstEmbed = new Embed()
      ...
      .setThumbnail(
        "https://upload-os-bbs.mihoyo.com/upload/2021/01/31/12293768/ff79c3511cb603c9d6c59862d02c8de9_7563784528451615190.jpg?x-oss-process=image/resize,s_740/quality,q_80/auto-orient,0/interlace,1/format,jpg",
      )
      .setFooter("Page 1/10")
      .setTimestamp()
      .setColor("RANDOM");
