...
createSubcommand("domain", {
  ...
  execute: async function (message, args) {
    const first = new Embed()
      ...
      .setThumbnail(
        "https://static.wikia.nocookie.net/gensin-impact/images/3/3c/Domain_Hidden_Palace_of_Zhou_Formula.png/revision/latest/scale-to-width-down/310?cb=20201221031231",
      )
      .setTimestamp()
    ...
    const second = new Embed()
      ...
      .setImage(
        "https://cdn.discordapp.com/attachments/799226933450768405/812971168872398888/unknown.png",
      )
      .setTimestamp()
