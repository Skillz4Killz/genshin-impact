...
createSubcommand("domain", {
  ...
  execute: async function (message, args) {
    const first = new Embed()
      ...
      .setThumbnail(
        "https://static.wikia.nocookie.net/gensin-impact/images/d/d8/Domain_Taishan_Mansion.png/revision/latest/scale-to-width-down/310?cb=20201221031419",
      )
      .setTimestamp()
    ...
    const second = new Embed()
      ...
      .setImage(
        "https://cdn.discordapp.com/attachments/798854249806037033/813054920177483826/XIyzU1h.png",
      )
      .setTimestamp()
