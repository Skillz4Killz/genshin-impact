...
createSubcommand("domain", {
  ...
  execute: async function (message, args) {
    const first = new Embed()
      ...
      .setThumbnail(
        "https://static.wikia.nocookie.net/gensin-impact/images/a/a1/Domain_Forsaken_Rift.png/revision/latest/scale-to-width-down/310?cb=20201221031430",
      )
      .setTimestamp()
    ...
    const second = new Embed()
      ...
      .setImage(
        "https://cdn.discordapp.com/attachments/798854249806037033/813055058555568138/PvNr1zo.png",
      )
      .setTimestamp()
