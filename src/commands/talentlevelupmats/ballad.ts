...
createSubcommand("material", {
  ...
  execute: async function (message) {
    ...
    .setDescription([
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/2/2f/Item_Guide_to_Ballad.png/revision/latest/scale-to-width-down/256?cb=20210106065423")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/2/2f/Item_Guide_to_Ballad.png/revision/latest/scale-to-width-down/256?cb=20210106065423")
      .setFooter("Page 2/3")
      .setColor("RANDOM")
