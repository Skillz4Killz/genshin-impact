...
createSubcommand("material", {
  name: "resistance",
  aliases: ["teachingsofresistance", "guidetoresistance", "philosophiesofresistance"],
  arguments: [
  ...
  execute: async function (message) {
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/3/33/Item_Teachings_of_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072033")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/3/33/Item_Teachings_of_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072033")
      .setFooter("Page 1/3")
      .setColor("RANDOM")
    ...
    .setDescription([
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/b/bf/Item_Guide_to_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072046")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/b/bf/Item_Guide_to_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072046")
      .setFooter("Page 2/3")
      .setColor("RANDOM")
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/0/0b/Item_Philosophies_of_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072058")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/0/0b/Item_Philosophies_of_Resistance.png/revision/latest/scale-to-width-down/256?cb=20210106072058")
      .setFooter("Page 3/3")
      .setColor("RANDOM")
