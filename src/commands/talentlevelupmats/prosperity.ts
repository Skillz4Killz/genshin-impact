...
createSubcommand("material", {
  name: "Prosperity",
  aliases: ["teachingsofprosperity", "guidetoprosperity", "philosophiesofprosperity"],
  arguments: [
  ...
  execute: async function (message) {
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/9/9e/Item_Teachings_of_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072137")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/9/9e/Item_Teachings_of_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072137")
      .setFooter("Page 1/3")
      .setColor("RANDOM")
    ...
    .setDescription([
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/6/67/Item_Guide_to_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072143")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/6/67/Item_Guide_to_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072143")
      .setFooter("Page 2/3")
      .setColor("RANDOM")
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/b/bd/Item_Philosophies_of_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072155")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/b/bd/Item_Philosophies_of_Prosperity.png/revision/latest/scale-to-width-down/256?cb=20210106072155")
      .setFooter("Page 3/3")
      .setColor("RANDOM")
