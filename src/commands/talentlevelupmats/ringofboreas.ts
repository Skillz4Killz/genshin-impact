...
createSubcommand("material", {
  ...
  execute: async function (message, args) {
    ...
    const embed = new Embed()
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/d/d6/Item_Ring_of_Boreas.png/revision/latest/scale-to-width-down/256?cb=20210106070626")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/d/d6/Item_Ring_of_Boreas.png/revision/latest/scale-to-width-down/256?cb=20210106070626")
      .setColor("RANDOM")
