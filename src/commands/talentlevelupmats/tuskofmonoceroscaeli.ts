...
createSubcommand("material", {
  ...
  execute: async function (message, args) {
    ...
    const embed = new Embed()
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/1/1c/Item_Tusk_of_Monoceros_Caeli.png/revision/latest/scale-to-width-down/256?cb=20210106065134")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/1/1c/Item_Tusk_of_Monoceros_Caeli.png/revision/latest/scale-to-width-down/256?cb=20210106065134")
      .setColor("RANDOM")
