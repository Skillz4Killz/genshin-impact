...
createSubcommand("material", {
  name: "diligence",
  aliases: ["teachingsofdiligence", "guidetodiligence", "philosophiesofdiligence"],
  arguments: [
  ...
  execute: async function (message) {
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/a/a7/Item_Teachings_of_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072237")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/a/a7/Item_Teachings_of_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072237")
      .setFooter("Page 1/3")
      .setColor("RANDOM")
    ...
    .setDescription([
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/9/9f/Item_Guide_to_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072243")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/9/9f/Item_Guide_to_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072243")
      .setFooter("Page 2/3")
      .setColor("RANDOM")
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/c/c2/Item_Philosophies_of_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072255")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/c/c2/Item_Philosophies_of_Diligence.png/revision/latest/scale-to-width-down/256?cb=20210106072255")
      .setFooter("Page 3/3")
      .setColor("RANDOM")
