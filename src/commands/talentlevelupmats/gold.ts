...
createSubcommand("material", {
  ...
  execute: async function (message) {
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/7/7f/Item_Teachings_of_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106072309")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/7/7f/Item_Teachings_of_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106072309")
      .setFooter("Page 1/3")
      .setColor("RANDOM")
    ...
    .setDescription([
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/4/43/Item_Guide_to_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106072319")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/4/43/Item_Guide_to_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106072319")
      .setFooter("Page 2/3")
      .setColor("RANDOM")
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/0/01/Item_Philosophies_of_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106064435")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/0/01/Item_Philosophies_of_Gold.png/revision/latest/scale-to-width-down/256?cb=20210106064435")
      .setFooter("Page 3/3")
      .setColor("RANDOM")
