...
createSubcommand("material", {
  ...
  execute: async function (message, args) {
    ...
    const embed = new Embed()
      ...
      .setThumbnail("https://static.wikia.nocookie.net/gensin-impact/images/0/04/Item_Crown_of_Insight.png/revision/latest/scale-to-width-down/256?cb=20201115225803")
      .setImage("https://static.wikia.nocookie.net/gensin-impact/images/0/04/Item_Crown_of_Insight.png/revision/latest/scale-to-width-down/256?cb=20201115225803")
      .setColor("RANDOM")
