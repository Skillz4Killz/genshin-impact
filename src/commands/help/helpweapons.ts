...
createSubcommand("help", {
  ...
  execute: async function (message, args) {
    ...
    const fifth = new Embed()
      .setTitle("Catalysts")
      .setDescription([
        `🔹 \`${prefix}help Magic Guide\``,
        `🔹 \`${prefix}help Thrilling Tales of Dragon Slayers\``,
        `🔹 \`${prefix}help Twin Nephrite\``,
        `🔹 \`${prefix}help Otherworldly Story\``,
        `🔹 \`${prefix}help Emerald Orb\``,
        "",
        `🔹 \`${prefix}help Solar Pearl\``,
        `🔹 \`${prefix}help Eye of Perception\``,
        `🔹 \`${prefix}help The Widsith\``,
        `🔹 \`${prefix}help Frostbearer\``,
        `🔹 \`${prefix}help Sacrificial Fragments\``,
        `🔹 \`${prefix}help Royal Grimoire\``,
        `🔹 \`${prefix}help Prototype Amber\``,
        `🔹 \`${prefix}help Mappa Mare\``,
        `🔹 \`${prefix}help Favonius Codex\``,
        `🔹 \`${prefix}help Blackcliff Agate\``,
        "",
        `🔹 \`${prefix}help Lost Prayer to the Sacred Winds\``,
        `🔹 \`${prefix}help Memory of Dust\``,
        `🔹 \`${prefix}help Skyward Atlas\``,
      ])
      .setTimestamp()
      .setFooter("Page 5/5")
